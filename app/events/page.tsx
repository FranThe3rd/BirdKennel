        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg leading-relaxed">
              Join us at our upcoming events to meet our hounds, connect with fellow foxhound enthusiasts, and support our mission.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg mb-8 leading-relaxed">
              We don&apos;t have any events scheduled right now, but we&apos;re always planning something special! Subscribe to our mailing list to find out when we set up events.
            </p>
