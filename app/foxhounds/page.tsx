...
export default function FoxhoundsPage() {
  ...
  useEffect(() => {
    fetch("/api/hounds/foxhounds", { cache: "no-store" })
      .then((res) => res.json())
    ...
    <main className="min-h-screen overflow-x-hidden relative">
      ...
      <section className="py-24 px-6 bg-background">
        <div className="max-w-7xl mx-auto">
          ...
          {!loadingHounds && foxhounds.length === 0 ? (
            <p className="text-center text-muted-foreground py-12">No foxhounds listed yet.</p>
          ) : null}
